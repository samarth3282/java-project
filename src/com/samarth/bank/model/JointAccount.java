...
/**
 * The {@code JointAccount} class represents a bank account which is jointly
 * held by two users.
...
public class JointAccount extends Account {
    ...
    /**
     * Default constructor initializing an empty joint account with a new User as
     * the second holder.
     */
    ...
    /**
     * Overloaded constructor initializing a joint account with a User as the second
     * holder.
     *
    ...
    /**
     * Overloaded constructor initializing a joint account with a first holder,
     * IBAN, initial balance and second holder.
     *
    ...
    /**
     * Checks if a given social security number (SSN) is the same as either the
     * first or the second account holder's.
     *
     * @param ssn the social security number to be checked
     * @return true if the given SSN matches either the first or the second
     *         holder's, false otherwise
     */
    @Override
