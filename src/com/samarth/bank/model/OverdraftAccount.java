 ...
 * This class extends the {@code Account} class and overrides the withdraw
 * method
...
public class OverdraftAccount extends Account {
    ...
    /**
     * Overloaded constructor initializing an overdraft account with a holder, IBAN,
     * and initial balance.
     *
    ...
    /**
     * Withdraws a given amount from the bank account if the holder's social
     * security number (SSN)
     * matches the one given. Unlike the parent {@code Account} class, it allows the
     * balance to go negative (overdraft).
     *
