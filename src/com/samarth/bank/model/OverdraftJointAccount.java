 ...
 * This class extends the {@code JointAccount} class and overrides the withdraw
 * method
...
public class OverdraftJointAccount extends JointAccount {
    ...
    /**
     * Overloaded constructor initializing an overdraft joint account with a first
     * holder, IBAN, initial balance and second holder.
     *
    ...
    /**
     * Withdraws a given amount from the joint bank account if the holder's social
     * security number (SSN)
     * matches the one given. Unlike the parent {@code JointAccount} class, it
     * allows the balance to go negative (overdraft).
     *
     * @param amount the amount to be withdrawn
     * @param ssn    the social security number of the account holder
     * @throws SsnNotValidException        if the social security number doesn't
     *                                     match the holder's SSN
    ...
    public void withdraw(double amount, String ssn)
        ...
        try {
            ...
            // Would be better to have more catch statements and have exception specific err
            // messages
